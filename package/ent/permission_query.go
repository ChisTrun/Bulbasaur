...
func (pq *PermissionQuery) QueryAction() *ActionQuery {
...
func (pq *PermissionQuery) Clone() *PermissionQuery {
	...
	return &PermissionQuery{
		...
		withAction: pq.withAction.Clone(),
...
func (pq *PermissionQuery) WithAction(opts ...func(*ActionQuery)) *PermissionQuery {
	query := (&ActionClient{config: pq.config}).Query()
...
//		GroupBy(permission.FieldActionID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.Permission.Query().
//		Select(permission.FieldActionID).
//		Scan(ctx, &v)
